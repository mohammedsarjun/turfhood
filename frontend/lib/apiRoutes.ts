...
export const API_ROUTES = {
  ...
  admin: {
    ...
    turfs: '/admin/turfs',
    suspendTurf: (id: string) => `/admin/turfs/${id}/suspend`,
    unsuspendTurf: (id: string) => `/admin/turfs/${id}/unsuspend`,
    commission: '/admin/commission',
    withdrawalRequests: '/admin/withdrawal-requests',
    markWithdrawalPaid: (id: string) => `/admin/withdrawal-requests/${id}/paid`,
    rejectWithdrawal: (id: string) => `/admin/withdrawal-requests/${id}/reject`,
  ...
  turfPayouts: (turfId: string) => `/turf-portal/${turfId}/payouts`,
  turfBankAccounts: (turfId: string) => `/turf-portal/${turfId}/payouts/bank-accounts`,
  turfWithdrawals: (turfId: string) => `/turf-portal/${turfId}/payouts/withdrawals`,
  openSessions: {
    base: '/open-sessions',
