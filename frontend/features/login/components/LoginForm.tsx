...
export function LoginForm({ signupSuccess }: LoginFormProps) {
  ...
  return (
    <div>
      ...
      <button
        type="button"
        className="flex h-11 w-full items-center justify-center rounded-md border border-border text-sm font-medium text-foreground transition-colors hover:bg-muted"
