...
import { DiscordAuthController } from '@presentation/user/controllers/DiscordAuthController';
...
import { validateDiscordAuthRequest } from '../validators/discordAuthValidator';
...
const discordAuthController = container.resolve(DiscordAuthController);
...
router.post('/discord', authRateLimiter, validateDiscordAuthRequest, discordAuthController.handle);
