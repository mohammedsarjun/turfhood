...
export interface ValidatedOwnerTurfRequest extends Request {
  validatedOwnerTurf?: ValidatedOwnerTurf;
}
export function validateOwnerTurfUpdate(req: Request, res: Response, next: NextFunction): void {
  ...
  (req as ValidatedOwnerTurfRequest).validatedOwnerTurf = result.data;
  next();
}
