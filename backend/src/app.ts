...
import ownerRevenueRoutes from '@presentation/turf/routes/ownerRevenue.routes';
import ownerPayoutRoutes from '@presentation/payout/routes/ownerPayout.routes';
import ownerOpenSessionRoutes from '@presentation/openSession/routes/ownerOpenSession.routes';
