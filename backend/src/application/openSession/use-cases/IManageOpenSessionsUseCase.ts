import type { CreateOpenSessionRequest, OpenSessionDTO, OpenSessionListResponse, OpenSessionPaymentResponse } from '@turfhood/shared';
...
export interface IManageOpenSessionsUseCase {
  ...
  list(input: { page: number; limit: number; sportTypeId?: string; latitude?: number; longitude?: number }): Promise<OpenSessionListResponse>;
