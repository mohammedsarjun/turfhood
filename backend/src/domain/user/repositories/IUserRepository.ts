...
export interface IUserRepository {
  ...
  linkDiscordAccount(userId: string, discordId: string, avatarUrl?: string): Promise<void>;
  ...
  /** Sets a password on an account that previously had none (e.g. a Google/Discord-only account). */
